...
public class MainPrueba {
	...
	public static void main(String[] args) {
		...
		//Oferta oferta0 = new Oferta(8,19,46000);
		Oferta oferta1 = new Oferta(8,12,16000);
		Oferta oferta2 = new Oferta(12,15,14000);
		Oferta oferta3 = new Oferta(11,16,10000);
		Oferta oferta4 = new Oferta(17,21, 14000);
		Oferta oferta5 = new Oferta(7, 11, 14000);
