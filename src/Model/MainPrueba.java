...
//		ComparePorCociente compareCoc = new ComparePorCociente();
		//Oferta oferta0 = new Oferta(8,19,16000.09);
		Oferta oferta1 = new Oferta(00,23,50000.02);
		Oferta oferta2 = new Oferta(12,15,25000.0);
		Oferta oferta3 = new Oferta(11,16,25000.01);
		Oferta oferta4 = new Oferta(17,21, 45000.09);
		Oferta oferta5 = new Oferta(7, 11, 45000.04);
